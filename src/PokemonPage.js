...
function Pokemon({ pokemonTrainer }) {
  ...
  return (
    <>
    {countdown === 0 ? <ScorePage pokemonTrainer={pokemonTrainerObject}/> : <div className="screen-wrapper">
        <div className="pokemon-wrapper">
          <div className = "headline-wrapper">
          <h1>
          NAME: {pokemonTrainerObject.name}<br />
          SCORE: {pokemonTrainerObject.score}<br />
          TIME LEFT: {countdown} </h1>           
          </div>
          {pokemonList[0] ? (
